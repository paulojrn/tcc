...
Atualmente existem muitas ferramentas para plataformas *desktop*, *web* e *mobile* que permitem a criação de casos de uso clássicos.

Contudo, ainda que seja um assunto importante, não existem ferramentas que integrem o uso do caso de uso 2.0 com a gerencia de um projeto de desenvolvimento. 

Nesse contexto, o objetivo desta pesquisa é desenvolver uma ferramenta que permita a criação de casos de uso 2.0 e 

O restante deste trabalho está organizado como segue: O capítulo 2 descreve fundamentos teóricos dessa pesquisa.
